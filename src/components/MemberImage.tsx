  ...
  return (
    <div className="relative w-full h-full">
      ...
      {!photo?.isApproved && !isAdmin && (
        <div className="absolute top-3 left-3 z-40 inline-flex max-w-[calc(100%-5.5rem)] items-center justify-center rounded-full border border-default-200 bg-white px-3 py-1.5 text-xs font-semibold text-default-900 shadow-sm shadow-default-100/40 sm:text-sm">
